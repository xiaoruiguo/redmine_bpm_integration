class CreateProcessDefinitionVersionAndRefactorDatabaseModel < ActiveRecord::Migration
  def change
    ...
    reversible do |direction|
      direction.up    { remove_foreign_key :bpmint_issue_process_instances, column: :process_definition_id }
      direction.down  { add_foreign_key :bpmint_issue_process_instances, :bpmint_process_def_versions, column: :process_definition_id }
    end
